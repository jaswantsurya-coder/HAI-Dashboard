  ...
  return (
    <div className="p-4 sm:p-8 max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col gap-1">
        <h1 className="text-3xl font-bold tracking-tight" style={{ fontFamily: "Georgia,serif" }}>Reviews</h1>
      ...
      <motion.div 
        ...
        <p className="text-muted-foreground max-w-md mx-auto text-sm">
          The Reviews tracking module is currently under development. Soon, you will be able to aggregate reviews from multiple platforms here.
        </p>
      </motion.div>
    </div>
  );
